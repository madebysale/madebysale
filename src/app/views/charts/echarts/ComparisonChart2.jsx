...
const ComparisonChart2 = ({ height }) => {
  ...
  const option = {
    ...
    legend: {
      itemGap: 20,
      icon: 'circle',
      textStyle: { color: palette.text.secondary, fontSize: 13, fontFamily: 'montserrat, sans-serif' },
    },
    color: [
      palette.error.light,
    ...
    xAxis: {
      ...
      axisTick: { show: false },
      axisLabel: { color: palette.text.secondary, fontSize: 13, fontFamily: 'montserrat, sans-serif' },
    },
    yAxis: {
      axisLine: { show: false },
      axisTick: { show: false },
